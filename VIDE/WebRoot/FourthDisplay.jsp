...
<html>
  ...
  <table align="center">
    ...
    <tr>
    <td>
    <font size="4" color="2F10E0" style="Harlow Solid Italic" >Books</font><font size="3" color="A8188E" style="Harlow Solid Italic" >(${searchinfo.booksno })</font>
    </td>
    </tr>
    <tr>
    <td>
   <font size="4" color="2F10E0" style="Harlow Solid Italic" >Mobile</font><font size="3" color="A8188E" style="Harlow Solid Italic" >(${searchinfo.mobileno })</font>
    </td>
    </tr>
    <tr>
    <td>
   <font size="4" color="2F10E0" style="Harlow Solid Italic" > Musical Inistuments</font> <font size="3" color="A8188E" style="Harlow Solid Italic" >(${searchinfo.musicno })</font>
  ...
  <table>
  <tr>
  <td><font size="5" color="teal" style="Harlow Solid Italic" >Title:${searchinfo.cname }</font></td>
  </tr>
  <tr>
  <td bgcolor="" ><img alt="SeeImage
  Here" id="previewField" src="userimages/${searchinfo.image }" height="90" width="90"></td>
  
  <td><font size="5" color="#23800D" style="Harlow Solid Italic" >${searchinfo.csubname }</font> <br/><br/><a href="#"><i>Buy Now:</i></a>$ <font size="5" color="#23800D" style="Harlow Solid Italic" >${searchinfo.price } </font></td>
  <td> &nbsp;&nbsp;&nbsp;&nbsp;</td>
  <td><font size="5" color="#23800D" style="Harlow Solid Italic" > (PaperBack - ${searchinfo.date })</font><br/><br/><a href="./BookDetails?cid=${searchinfo.cid }">About Content</a></td>
 </tr>
 
   
  <tr><td colspan="4"><font size="5" color="#D92911" style="Harlow Solid Italic" ><i>In Stock</i></td><tr>
    ...
    <table align="center"><tr><td width="100%">
      ...
      if(pageNo>0) {%><a href="./FourthDisplay.jsp?page=0&title=<%=title%>">First</a>|<a href="./FourthDisplay.jsp?page=<%=pageNo-1%>&title=<%=title%>"><< |</a>
      <%}
     // int count=0;
      for(int i=0;i<totalpages;i++){
      if((i==pageNo-2)||(i==pageNo-1)||(i==pageNo)||(i==pageNo+1)||(i==pageNo+2)){
      if(!(pageNo==i)){%><a href="FourthDisplay.jsp?page=<%=i %>&title=<%=title%>"><%}%> <%=(i+1) %></a> | 
      <%//count++;
      }
      //if(count==5)break;
      }
      
      %><%if(pageNo<totalpages-1) {%><a href="FourthDisplay.jsp?page=<%=pageNo+1%>&title=<%=title%>">>> |</a><a href="FourthDisplay.jsp?page=<%=totalpages-1%>&title=<%=title%>">Last</a><%} }%></td></tr>
