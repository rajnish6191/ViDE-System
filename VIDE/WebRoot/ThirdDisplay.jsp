...
<html>
  ...
  <table align="center">
    ...
    <tr>
    <td>
   <font size="5" color="#3D58F2" style=""> Books</font><font size="5" color="#0EC972" style="">(${searchinfo.booksno })</font>
    </td>
    </tr>
    <tr>
    <td>
   <font size="5" color="#3D58F2" style="">Mobile </font><font size="5" color="#0EC972" style="">(${searchinfo.mobileno })</font>
    </td>
    </tr>
    <tr>
    <td>
   <font size="5" color="#3D58F2" style="">Musical Inistuments</font><font size="5" color="#0EC972" style="">(${searchinfo.musicno })</font>
  ...
  <table>
  <tr>
  <td><font size="5" color="" style="">Title:</font><font size="6" color="#8A0FDB" style=""><i>${searchinfo.cname }</i></font></td>
  </tr>
  <tr>
  <td bgcolor="#F4F5F7" ><img alt="SeeImage
  Here" id="previewField" src="userimages/${searchinfo.image }" height="90" width="90"></td>
  
  <td><font size="5" color="#85308A" style="Harlow Solid Italic" ><i>${searchinfo.csubname }</i></font> <br/><br/><a href="#"><i>Buy Now:</i></a>$ <font size="5" color="#85308A" style=""><i>${searchinfo.price } </i></font></td>
  <td> &nbsp;&nbsp;&nbsp;&nbsp;</td>
  <td><font size="5" color="#85308A" style=""><i> (PaperBack - ${searchinfo.date })</i></font><br/><br/><a href="./BookDetails?cid=${searchinfo.cid }">About Content</a></td>
 </tr>
 
   
  <tr><td colspan="4"><i><font size="5" color="#F23D91" style="">In Stock</font></i></td><tr>
    ...
    <table align="center"><tr><td width="100%">
      ...
      if(pageNo>0) {%><a href="./ThirdDisplay.jsp?page=0&title=<%=title%>">First</a>|<a href="./ThirdDisplay.jsp?page=<%=pageNo-1%>&title=<%=title%>"><< |</a>
      <%}
     // int count=0;
      for(int i=0;i<totalpages;i++){
      if((i==pageNo-2)||(i==pageNo-1)||(i==pageNo)||(i==pageNo+1)||(i==pageNo+2)){
      if(!(pageNo==i)){%><a href="ThirdDisplay.jsp?page=<%=i %>&title=<%=title%>"><%}%> <%=(i+1) %></a> | 
      <%//count++;
      }
      //if(count==5)break;
      }
      
      %><%if(pageNo<totalpages-1) {%><a href="ThirdDisplay.jsp?page=<%=pageNo+1%>&title=<%=title%>">>> |</a><a href="ThirdDisplay.jsp?page=<%=totalpages-1%>&title=<%=title%>">Last</a><%} }%></td></tr>
